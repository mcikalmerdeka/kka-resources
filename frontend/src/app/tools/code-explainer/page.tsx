...
export default function CodeExplainerPage() {
  ...
  const languagesList = ["Python", "JavaScript", "Java", "C++", "HTML/CSS"];
              ...
              <div className="flex-1 min-h-[300px] border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-green-500 focus-within:border-transparent bg-gray-50 relative">
                ...
                <div className="h-full font-mono text-sm relative">
                  ...
                  <Editor
                    ...
                    highlight={code => highlight(code, languagesList.includes(language) ? Prism.languages[language.toLowerCase()] || Prism.languages.javascript : Prism.languages.javascript, language)}
                    padding={16}
