...
import { Languages, Send, Loader2, ArrowRightLeft } from 'lucide-react';
...
export default function TranslatorPage() {
  ...
  const languagesList = ["Bahasa Indonesia", "English", "Mandarin", "Arabic", "Spanish", "French", "Japanese", "Korean"];
