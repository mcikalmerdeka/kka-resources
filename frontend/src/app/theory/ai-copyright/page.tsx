import { Copyright, Scale, Image, Music, Newspaper, ShieldAlert, BookOpen, AlertTriangle, Palette, Mic2 } from 'lucide-react';
  ...
  return (
    <PageWrapper
      header={{
        ...
        description: "AI Theory",
        icon: <Copyright className="w-6 h-6 text-amber-600" />,
      }}
    >
