import { Ghost, AlertTriangle, Plane, Stethoscope, Gavel, Building, Search, HelpCircle, ShieldAlert, Brain } from 'lucide-react';
  ...
  return (
    <PageWrapper
      header={{
        ...
        icon: <Ghost className="w-6 h-6 text-red-600" />,
      }}
    >
